...
function CalEmbed() {
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      if (Cal) {
        ...
        Cal.ns["chat-with-me"]("ui", { hideEventTypeDetails: false, layout: "month_view" });
      }
    };
  ...
  return <div style={{ width: "100%", height: "100%", overflow: "auto" }} id="my-cal-inline-chat-with-me"></div>;
}
