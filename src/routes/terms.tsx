      ...
      <section>
        <div className="container-tight max-w-3xl space-y-8 py-12 text-[15px] leading-relaxed">
          ...
          <Block title="1. Who these terms are between">
            <p>
              These terms are between 2026 Script &amp; Scale - Sole Proprietor (&ldquo;we&rdquo;, &ldquo;us&rdquo;) and the
          ...
          <Block title="2. What we deliver">
            ...
            <ul className="list-disc space-y-2 pl-5">
              <li><strong>Opener, £525/mo:</strong> one 30–45 min workshop per month, core script, top-10 objection library, recorded workshops.</li>
              <li><strong>Closer, £1,050/mo:</strong> everything in Opener, plus biweekly workshops, follow-up SOPs, weekly-relevant roleplay drills.</li>
              <li><strong>Rainmaker, £2,100/mo:</strong> everything in Closer, plus weekly workshops, tonality coaching on real recordings, live call review.</li>
            </ul>
            <p>
