    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          Broken link, or a page that never existed. Head home.
        </p>
        <div className="mt-6">
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Not your fault. Try again or head home.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Script & Scale — Revenue Enablement" },
      {
        ...
        content:
          "Fix founder-led sales. Workshops, scripts, objection library, live call review. Guarantee on the first three months.",
      },
